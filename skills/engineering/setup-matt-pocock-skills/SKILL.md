...
description: "Configure this repo for the engineering skills: set up its issue tracker, PRD tracker, triage label vocabulary, and domain doc layout. Run once before first use of the other engineering skills."
